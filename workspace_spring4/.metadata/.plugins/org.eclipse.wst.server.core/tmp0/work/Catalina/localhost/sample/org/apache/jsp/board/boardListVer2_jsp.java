 ...
 * Generated at: 2019-09-03 09:28:07 UTC
...
//총 레코드 개수
	...
	if(request.getParameter("nowPage")!=null){
      ...
      out.write("\t\t//vbmnos ==>12,9,8:쿼리 스트링으로 넘길 값\r\n");
      out.write("\t\tvar vbmnos=\"\";\r\n");
      out.write("\t\tvar vbsfiles=\"\";\r\n");
      out.write("\t\t//배열에 담기 위해 선언한 배열 객체\r\n");
      out.write("\t\tvar bmnoArr=[];\r\n");
      out.write("\t\tvar bsfileArr=[];\r\n");
      out.write("\t\t//샌턱한 로우의 값을 담을 변수-배열\r\n");
      out.write("\t\tvar rows = $(\"#dg_board\").datagrid('getSelections');\r\n");
      out.write("\t\talert(\"로우 개수 : \"+rows.length);\r\n");
      out.write("\t\t$.messager.confirm('Confirm','정말 삭제하시겠습니까?',function(r){\r\n");
      out.write("\t\t\tif(r){\r\n");
      out.write("\t\t\t\t//사용자가 선택한 로우에 대한 Object를 이용하면 field에 접근할 수 있다.\r\n");
      out.write("\t\t\t\tif(rows==null){\r\n");
      out.write("\t\t\t\t\talert(\"삭제할 글을 선택하세요.\");\r\n");
      out.write("\t\t\t\t\treturn; //deleterow 함수 탈출\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t//선택한 로우의 객체배열을 활용하여 값 로우에 담긴 글번호를 배열 안에 넣기\r\n");
      out.write("\t\t\t//아래 변수는 선택한 로우에서 글 번호는 존재하지만 첨부파일이 없는 경우\r\n");
      ...
      out.write("\t\t\tfor(var i=0;i<isOk;i++){\r\n");
      out.write("\t\t\t\t//필드명은 myBatis의 Map을 사용하였으므로 반드시 대문자로 처리함.\r\n");
      out.write("\t\t\t\tbsfileArr.push(rows[i].BS_FILE2);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t//배열에 담긴 정보 출력해보기\r\n");
      out.write("\t\t\tfor(var i=0; i<rows.lenth;i++){\r\n");
      out.write("\t\t\t\tif(i==(rows.length-1)){\r\n");
      out.write("\t\t\t\t\tvbmnos +=bmnoArr[i];\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t//뒤에 값이 더 있을 경우에는 콤마를 붙여준다.\r\n");
      out.write("\t\t\t\t//자바코드에서 StringTokenizer로 문자열을 썰 때 ,를 기준으로 썰어서 담으니까\r\n");
      out.write("\t\t\t\t//맨 끝에 콤마가 있으면 실제 있는 값보다 1개가 더 생김.\r\n");
      out.write("\t\t\t\telse{\r\n");
      out.write("\t\t\t\t\tvbmnos +=bmnoArr[i]+\",\";\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t//12, 9, 6\r\n");
      out.write("\t\t\tlocation.href=\"/sample/board/boardDELALL.mvc?bmnos=\"+vbmnos+\"&bsfiles=\"+vbsfiles;//서버에 요청(전송방식:get)\r\n");
      out.write("\t\t\t//화면상에서만 삭제된다 - 삭제 후 새로 select 처리할 것이므로 의미없다.\r\n");
      out.write("\t\t\t//$(\"gird_emp\").datagrid('deleteRow',getRowIndex(target));\r\n");
      out.write("\t\t\t}/////////////////end of if\r\n");
      out.write("\t\t});///////////////////end of confirm\r\n");
      out.write("\t}/////////////////////////end of deleteform\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\tlocation.href='/sample/board/boardList.mvc?cb_search='+cb_value\r\n");
      out.write("\t\t +'&keyword='+tb_value\r\n");
      out.write(" \t\t +'&pageNumber=1'\r\n");
      out.write("\t\t +'&pageSize=10' \r\n");
      out.write("\t \r\n");
      out.write("\t\t$(\"#dg_board\").datagrid({\r\n");
      out.write("\t\t\t url:'/sample/board/boardList.mvc?cb_search='+cb_value\r\n");
      out.write("\t\t\t\t\t +'&keyword='+tb_value\r\n");
      out.write("\t\t\t \t\t +'&pageNumber=1'\r\n");
      out.write("\t\t\t\t\t +'&pageSize=10' \r\n");
      ...
      out.write("\t\t$(\"#dg_board\").datagrid({\r\n");
      out.write("\t\t\turl:\"/sample/board/boardList.mvc?pageNumber=\"+pageNumber+\"&pageSize=\"+pageSize\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\tlocation.href='/sample/board/boardDel.mvc?delAll=delAll'\r\n");
      out.write("\t\t\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t</script>\r\n");
	...
	path.append("/");
      ...
      out.write("          \t<th data-options=\"field:'BS_FILE2',width:'200px',hidden:'true'\">&nbsp;</th>\r\n");
      ...
      out.write("\t \t <tr>\r\n");
      out.write("\t \t <!-- \r\n");
      out.write("\t \t header영역에서 hidden으로 처리해서 화면상에는 보이지 않지만 datagrid 안에는 값이 들어있는 상태여야 함.\r\n");
      ...
      out.write("\t \t \t<td>\r\n");
      out.write("\t \t \t<!-- 너 댓글이니? -->\r\n");
      out.write("\t \t \t<!-- path ==> JEasyUICommon 소스가 다이렉티브 방식으로 include 돼서 하나로 합쳐지기 때문에 에러가 나지 않음. -->\r\n");
      out.write("\t");
      ...
      out.write("        <a href=\"javascript:deleteRow()\" class=\"easyui-linkbutton\" iconCls=\"icon-cancel\" plain=\"true\" >삭제</a>\r\n");
      out.write("    </div>\r\n");
      out.write("    \r\n");
      out.write("    <!-- ======================[[페이지네이션 추가 ]]=============================-->\r\n");
	...
	out.print(pagination);
      ...
      out.write("\t-->\r\n");
      out.write("\r\n");
      out.write("<!-- <form id=\"f_boardAdd\" method=\"get\"> -->\r\n");
