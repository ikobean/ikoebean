...
public class PageBar {
	 ...
	 * 
	 * 화면에 내보내 져야하는 언어는 html 아님 자바 중에서 ???????
	 * html
	...
	public void setPageBar() {
		...
		if(totalRecord>0) {
			...
			if(nowBlock >0) {
				...
				pageLink.append("<img border=0 src='/images/before.png'>");
				pageLink.append("</a>&nbsp;&nbsp;");
			}
			...
			if(totalBlock > nowBlock+1) {
				...
				pageLink.append("<img border=0 src='/images/next.png'>");
				pageLink.append("</a>");
			}
		}
		//pageLink.append("<a href=test.mo?crud=boardList&nowPage="+nowPage+">1</a> <b>2</b>");
