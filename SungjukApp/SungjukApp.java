...
public class SungjukApp extends JFrame implements ActionListener {
	...
	//////////////화면에서 입력받은 값 받아오기. 이걸로 VO에 paVO로 뿌려줄거야
	public String getName() {return jtf.getText();}
	public void setName(String name) { jtf.setText(name);};
	
	public String getJava() {return jtf1.getText();}
	public void setJava(String java) { jtf1.setText(java);};
	
	public String getOracle() {return jtf2.getText();}
	public void setOracle(String oracle) { jtf2.setText(oracle);};
	
	public String getJsp() {return jtf3.getText();}
	public void setJsp(String jsp) { jtf3.setText(jsp);};
	
	public String getTotal() {return jtf4.getText();}
	public void setTotal(String total) { jtf4.setText(total);};
	
	public String getAvg() {return jtf5.getText();}
	public void setAvg(String avg) { jtf5.setText(avg);};
	
	public String getRank() {return jtf6.getText();}
	public void setRank(String rank) { jtf6.setText(rank);};
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj==jbtn_ins) {
			try {
				SJAppVO paVO = new SJAppVO();
				paVO.setCommand("insert");			
				paVO.setName(getName());  
				paVO.setJava(getJava());  
				paVO.setOracle(getOracle());
				paVO.setJsp(getJsp());   
				paVO.setTotal(getTotal()); 
				paVO.setAvg(getAvg());   
				paVO.setRank(getRank());
				SJAppCtrl sCtrl = new SJAppCtrl();
				sCtrl.send(paVO);
				System.out.println("RRRR"+paVO.getName());
			} catch (Exception e2) {
				e2.printStackTrace();
			}
