	...
	화면에 담겨있는 정보들은 가독성이 떨어지고 화면 내용이 많아지게 되면 찾기가 불편함.
	 ...
	 <!-- =========================우편번호 검색기 ========================-->
	 	<div id="dlg_zip" style="padding: 30px 60px;">
			...
			<a id="btn_search" href="#" class="easyui-linkbutton"	data-options="iconCls:'icon-search',plain:true">검색 </a> 
		...
		<form id="f_ins">
			...
			<div style="margin-bottom: 10px">
				<input class="easyui-textbox" name="mem_zipcode" label="Zipcode" labelPosition="top"
					style="width: 70%;">
					<a id="btn_zip" href="#" class="easyui-linkbutton"
					data-options=plain:true">우편번호 </a>
			</div>
			<div style="margin-bottom: 10px">
