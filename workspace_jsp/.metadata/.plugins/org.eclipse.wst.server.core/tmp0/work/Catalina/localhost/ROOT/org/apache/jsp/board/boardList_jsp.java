 ...
 * Generated at: 2019-08-12 01:05:26 UTC
...
//총 레코드 개수
	...
	if(session.getAttribute("s_tot")!=null){
      ...
      out.write("\t\t$('#f_boardAdd').attr(\"action\",\"/board/test.nb?crud=boardAdd\"); //전송을 하는 곳.\r\n");
      ...
      out.write("\t\t\t\t $.ajax({\r\n");
      out.write("\t\t\t\t\t url:\"test.nb?crud=total&cb_search=\"+cb_value+'&keyword='+tb_value&\"timestamp=\"+new Date().getTime()\r\n");
      ...
      out.write("\t\t\t\t      ,{field:'BM_CONTENT',title:'내용', hidden:'true'}\r\n");
      ...
      out.write("\t\t\t\t      ,{field:'BM_EMAIL',title:'이메일', hidden:'true'}\r\n");
      out.write("\t\t\t\t      \r\n");
      out.write("\t\t\t\t    ]]\r\n");
      ...
      out.write("\t\t\t\t\tcmm_window_popup(\"test.nb?crud=boardDetail&bm_no=\"+g_no,\"700\",\"450\",\"read\");\r\n");
      out.write("\t\t\t\t\t//선택한 로우값 초기화\r\n");
      out.write("\t\t\t\t\t$(\"#dg_board\").datagird('clearSelections');\r\n");
      out.write("\t\t\t\t}\t\t\r\n");
      out.write("\t\t\t\t//아님 첨부파일이야?\r\n");
      out.write("\t\t\t\telse if(\"BS_FILE\"==field){\r\n");
      out.write("\t\t\t\t\tlocation.href=\"download.jsp?bs_file=\"+value;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}////////////////////End of onDblClickCell\r\n");
      out.write("\t\t});\r\n");
      out.write(" \r\n");
