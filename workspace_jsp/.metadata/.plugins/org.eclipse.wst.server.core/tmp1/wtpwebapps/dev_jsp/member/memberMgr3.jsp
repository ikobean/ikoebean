         ...
         <input type="hidden" id="work" name="work" value="member">
               <div style="margin-bottom:20px">
                    <input class="easyui-textbox" id="mem_id" name="mem_id" label="아이디"
                     labelPosition="top" style="width:400px;">
             </div>
             <div style="margin-bottom:20px">
                 <input class="easyui-textbox" id="mem_name" name="mem_name" label="이름" 
                 labelPosition="top" style="width:400px;">
             </div>
             <div style="margin-bottom:20px">
                 <input class="easyui-textbox" id="mem_zipcode" name="mem_zipcode" label="우편변호"
                  labelPosition="top" style="width:300px;">
                <a id="btn_zipcode" href="#" class="easyui-linkbutton" onclick="">우편번호 검색</a>
             </div>
             <div style="margin-bottom:20px">
                 <input class="easyui-textbox" id="mem_addr" name="mem_addr" label="주소" 
                 labelPosition="top" style="width:400px;">
             </div>
             <div style="margin-bottom:20px">
                 <input class="easyui-textbox" id="mem_pw" name="mem_pw" label="비밀번호"
                  labelPosition="top" style="width:400px;">
             </div>
      </form>
   </div>
