...
public class followList_h extends JPanel {
	//JLabel jlb_rank = null;
		...
		public followList_h(int i,MainPage page) {
			...
			//빈공간 배경색설정
			jp_blank.setSize(200, 200);
		
			
			
				jp_profile = new ProfileImg(imgName,20,0,80,80);
					GroupLayout layout = new GroupLayout(this);
					this.setLayout(layout);
					layout.setHorizontalGroup(layout.createSequentialGroup()
							.addComponent(jp_blank,20,20,20)
							.addComponent(jp_profile,80,80,80)
							.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
									.addComponent(jlb_nick,310,310,310)
									.addComponent(jlb_id,310,310,310)
									)
							);
					layout.setVerticalGroup(layout.createSequentialGroup()
							.addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
									...
									.addGroup(layout.createSequentialGroup()
											.addComponent(jlb_nick,50,50,50)
											.addComponent(jlb_id,50,50,50)
											)
									)
							);
